// dialog
export const internalServerErrorTitle = '通信に失敗しました';
export const internalServerErrorDescription = 'サーバーが応答を停止しています';
...
export const askLabelDeleteDialog = 'このラベルを削除してよろしいですか？';
...
export const deleteCardButtonText = 'カードを削除';
export const cardNameFormPlaceholder = 'カード名を入力';
export const cardDescriptionPlaceholder = 'カードの説明を追加';
...
// search
export const failedSearchCard = 'カードの検索に失敗しました';
